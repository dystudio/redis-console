...
public class Page<T> {
    ...
    public void pageViewAjax(String url, String params) {
        ...
        if (this.pageNo != 1) {
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=1" + params + "',this)\"><font size=2>首页</font></a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo - 1) + params + "',this)\"><font size=2>上一页</font></a>");
        }
        ...
        if (this.getTotalPage() <= 10) {
            for (int i = 0; i < this.getTotalPage(); i++) {
                ...
                pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (i + 1) + params + "',this)\">" + (i + 1) + "</a>");
            }
        } else if (this.getTotalPage() <= 20) {
            //没有把...加上
            int l;
            ...
            for (int i = tmp; i < tmp + 10; i++) {
                ...
                pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (i) + params + "',this)\">" + (i) + "</a>");
            }
            ...
            pageView.add("...");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.getTotalPage() - 1) + params + "',this)\">" + (this.getTotalPage() - 1) + "</a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.getTotalPage()) + params + "',this)\">" + (this.getTotalPage()) + "</a>");
        } else if (this.pageNo > this.getTotalPage() - 6) {
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (1) + params + "',this)\">" + (1) + "</a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (2) + params + "',this)\">" + (2) + "</a>");
            pageView.add("...");
            for (int i = this.getTotalPage() - 8; i < this.getTotalPage(); i++) {
                if (i + 1 == this.pageNo) {
                    pageView.add("<strong>" + this.pageNo + "</strong>");
            ...
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo - 2) + params + "',this)\">" + (this.pageNo - 2) + "</a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo - 1) + params + "',this)\">" + (this.pageNo - 1) + "</a>");
            pageView.add("<strong>" + this.pageNo + "</strong>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo + 1) + params + "',this)\">" + (this.pageNo + 1) + "</a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo + 2) + params + "',this)\">" + (this.pageNo + 2) + "</a>");
        ...
        if (this.pageNo != this.getTotalPage()) {
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.pageNo + 1) + params + "',this)\"><font size=2>下一页</font></a>");
            pageView.add("<a href=\"javascript:void(0);\" onclick=\"pageViewAjax('" + url + "?pageNo=" + (this.getTotalPage()) + params + "',this)\"><font size=2>尾页</font></a>");
        }
    }
